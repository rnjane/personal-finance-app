...
urlpatterns = [
    ...
    url(r'^(?P<budget_id>[0-9]+)/income/(?P<income_id>[0-9]+)/edit_income/$', views.edit_income, name='edit_income'),
    url(r'^(?P<budget_id>[0-9]+)/income/(?P<income_id>[0-9]+)/delete_income/$', views.delete_income, name='delete_income'),
